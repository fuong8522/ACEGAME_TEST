...
public class Player : MonoBehaviour
{
    ...
    public void CheckBoxcast()
    {
        if(OnGround() == false)
        {
            RaycastHit2D rayHit1 = Physics2D.Raycast(boxCollider.bounds.center + new Vector3(valueChange, 0, 0), Vector2.up, boxCollider.bounds.extents.y + heigh, layerMaskEnemy);
            RaycastHit2D rayHit2 = Physics2D.Raycast(boxCollider.bounds.center + new Vector3(-valueChange, 0, 0), Vector2.up, boxCollider.bounds.extents.y + heigh, layerMaskEnemy);
